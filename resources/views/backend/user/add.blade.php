                                 ...
                                 <div class="form-group">
                                  <label class="col-md-3 col-xs-12 control-label">First Name <span style="color:red"> *</span></label>
                                      <div class="col-md-7 col-xs-12">
                                          <div class="">
                                              <input name="firstname" value="{{ old('firstname') }}" placeholder="First Name" type="text" required class="form-control" />
                                  ...
                                  <label class="col-md-3 col-xs-12 control-label">Country <span style="color:red"> </span></label>
                                      <div class="col-md-7 col-xs-12">
                                          <div class="">
                                              <input name="country" value="{{ old('country') }}" placeholder="Country" type="text" class="form-control" />
                                  ...
                                  <label class="col-md-3 col-xs-12 control-label">Age <span style="color:red"> </span></label>
                                      <div class="col-md-7 col-xs-12">
                                          <div class="">
                                              <input name="age" value="{{ old('age') }}" placeholder="Age" type="number" class="form-control" />
